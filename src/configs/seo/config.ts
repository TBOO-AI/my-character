...
export const config: DefaultSeoProps = {
  ...
  titleTemplate: 'TBOO | %s', // 타이틀에 추가될 기본 title 템플릿입니다. 각 페이지에서 작성한 title이 %s에 적용됩니다.
  defaultTitle: 'TBOO', // 페이지에 title이 설정되어 있지 않으면 빈 정보 대신 defaultTitle이 사용됩니다.
  description: 'check your fortune today!', // 페이지의 meta 설명 설정입니다.
  canonical: 'https://my.tboo.ai/', // 페이지의 표준 URL 설정입니다.
  openGraph: {
    /**
     * Open Graph Protocol에 대한 자세한 설명은 아래의 링크를 참조합니다.
     * @see https://ogp.me/
     */
    title: 'TBOO', // 사이트의 제목 태그입니다.
    type: 'website', // 사이트의 종류입니다.
    locale: 'ko_KR', // 사이트의 언어 설정입니다.
    url: 'https://my.tboo.ai/', // 사이트의 대표 URL입니다.
    siteName: 'TBOO', // 전체 사이트에 대해 표시되어야 하는 이름입니다.
    description: 'check your fortune today!', // 사이트에 대한 설명입니다. meta description과 다를 수 있습니다.
    images: [
